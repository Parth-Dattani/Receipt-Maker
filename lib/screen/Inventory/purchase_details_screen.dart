      ...
      child: ConstrainedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            // --- RIGHT COLUMN: Details & Summary (Flex 2) ---
            Expanded(
              flex: 2,
              child: Container(
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("vendor_information".tr, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.tealColor)),
            const SizedBox(height: 12),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Items Subtotal (${controller.purchaseItems.length} items):", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.tealColor)),
